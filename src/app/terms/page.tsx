    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <Card>
        ...
        <CardContent className="space-y-4 text-muted-foreground">
          <p>By using Resume Master AI ("we," "us," or "our"), you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our services.</p>
          
          <h2 className="text-xl font-semibold text-foreground pt-4">Use of Service</h2>
          <p>Resume Master AI provides resume templates and AI-powered tools for personal, non-commercial use. You agree not to misuse the service or help anyone else to do so.</p>
          ...
          <p>The website and its original content, features, and functionality are owned by Resume Master AI and are protected by international copyright, trademark, and other intellectual property laws.</p>
          
          <h2 className="text-xl font-semibold text-foreground pt-4">Limitation of Liability</h2>
          <p>In no event shall Resume Master AI be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your access to or use of or inability to access or use the service.</p>
